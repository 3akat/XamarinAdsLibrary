...
AndroidX Bindings NuGet Package Xamarin.AndroidX.ConstraintLayout.Core 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.ConstraintLayout.Core 
for Maven artifact:

artifact=androidx.constraintlayout:constraintlayout-core 

artifact_versioned=androidx.constraintlayout:constraintlayout-core:1.0.4

nuget=constraintlayout-core.1.0.4.9
