...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Print 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Print 
for Maven artifact:

artifact=androidx.print:print 

artifact_versioned=androidx.print:print:1.0.0

nuget=print.1.0.0.22
