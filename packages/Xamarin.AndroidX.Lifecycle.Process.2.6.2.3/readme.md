...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Lifecycle.Process 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Lifecycle.Process 
for Maven artifact:

artifact=androidx.lifecycle:lifecycle-process 

artifact_versioned=androidx.lifecycle:lifecycle-process:2.6.2

nuget=lifecycle-process.2.6.2.3
