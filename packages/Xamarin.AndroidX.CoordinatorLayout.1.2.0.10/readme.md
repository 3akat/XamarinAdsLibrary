...
AndroidX Bindings NuGet Package Xamarin.AndroidX.CoordinatorLayout 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.CoordinatorLayout 
for Maven artifact:

artifact=androidx.coordinatorlayout:coordinatorlayout 

artifact_versioned=androidx.coordinatorlayout:coordinatorlayout:1.2.0

nuget=coordinatorlayout.1.2.0.10
