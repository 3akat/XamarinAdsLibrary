...
AndroidX Bindings NuGet Package Xamarin.AndroidX.VectorDrawable.Animated 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.VectorDrawable.Animated 
for Maven artifact:

artifact=androidx.vectordrawable:vectordrawable-animated 

artifact_versioned=androidx.vectordrawable:vectordrawable-animated:1.1.0

nuget=vectordrawable-animated.1.1.0.22
