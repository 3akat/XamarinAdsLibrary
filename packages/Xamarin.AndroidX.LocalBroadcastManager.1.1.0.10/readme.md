...
AndroidX Bindings NuGet Package Xamarin.AndroidX.LocalBroadcastManager 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.LocalBroadcastManager 
for Maven artifact:

artifact=androidx.localbroadcastmanager:localbroadcastmanager 

artifact_versioned=androidx.localbroadcastmanager:localbroadcastmanager:1.1.0

nuget=localbroadcastmanager.1.1.0.10
