...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Core.Core.Ktx 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Core.Core.Ktx 
for Maven artifact:

artifact=androidx.core:core-ktx 

artifact_versioned=androidx.core:core-ktx:1.12.0

nuget=core-ktx.1.12.0.3
