...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Loader 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Loader 
for Maven artifact:

artifact=androidx.loader:loader 

artifact_versioned=androidx.loader:loader:1.1.0

nuget=loader.1.1.0.22
