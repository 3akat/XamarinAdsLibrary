...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Lifecycle.ViewModel 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Lifecycle.ViewModel 
for Maven artifact:

artifact=androidx.lifecycle:lifecycle-viewmodel 

artifact_versioned=androidx.lifecycle:lifecycle-viewmodel:2.6.2

nuget=lifecycle-viewmodel.2.6.2.3
