...
AndroidX Bindings NuGet Package Xamarin.AndroidX.ViewPager 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.ViewPager 
for Maven artifact:

artifact=androidx.viewpager:viewpager 

artifact_versioned=androidx.viewpager:viewpager:1.0.0

nuget=viewpager.1.0.0.22
