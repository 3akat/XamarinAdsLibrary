...
AndroidX Bindings NuGet Package Xamarin.AndroidX.ResourceInspection.Annotation 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.ResourceInspection.Annotation 
for Maven artifact:

artifact=androidx.resourceinspection:resourceinspection-annotation 

artifact_versioned=androidx.resourceinspection:resourceinspection-annotation:1.0.1

nuget=resourceinspection-annotation.1.0.1.10
