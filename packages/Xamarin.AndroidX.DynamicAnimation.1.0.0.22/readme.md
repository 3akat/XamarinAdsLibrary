...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DynamicAnimation 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DynamicAnimation 
for Maven artifact:

artifact=androidx.dynamicanimation:dynamicanimation 

artifact_versioned=androidx.dynamicanimation:dynamicanimation:1.0.0

nuget=dynamicanimation.1.0.0.22
