...
AndroidX Bindings NuGet Package Xamarin.AndroidX.VectorDrawable 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.VectorDrawable 
for Maven artifact:

artifact=androidx.vectordrawable:vectordrawable 

artifact_versioned=androidx.vectordrawable:vectordrawable:1.1.0

nuget=vectordrawable.1.1.0.22
