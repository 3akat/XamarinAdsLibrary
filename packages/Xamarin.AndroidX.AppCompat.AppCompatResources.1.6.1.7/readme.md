...
AndroidX Bindings NuGet Package Xamarin.AndroidX.AppCompat.AppCompatResources 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.AppCompat.AppCompatResources 
for Maven artifact:

artifact=androidx.appcompat:appcompat-resources 

artifact_versioned=androidx.appcompat:appcompat-resources:1.6.1

nuget=appcompat-resources.1.6.1.7
