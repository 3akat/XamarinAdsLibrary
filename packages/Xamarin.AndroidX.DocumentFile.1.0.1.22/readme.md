...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DocumentFile 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DocumentFile 
for Maven artifact:

artifact=androidx.documentfile:documentfile 

artifact_versioned=androidx.documentfile:documentfile:1.0.1

nuget=documentfile.1.0.1.22
