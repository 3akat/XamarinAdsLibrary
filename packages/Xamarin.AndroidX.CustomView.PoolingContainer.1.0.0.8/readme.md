...
AndroidX Bindings NuGet Package Xamarin.AndroidX.CustomView.PoolingContainer 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.CustomView.PoolingContainer 
for Maven artifact:

artifact=androidx.customview:customview-poolingcontainer 

artifact_versioned=androidx.customview:customview-poolingcontainer:1.0.0

nuget=customview-poolingcontainer.1.0.0.8
