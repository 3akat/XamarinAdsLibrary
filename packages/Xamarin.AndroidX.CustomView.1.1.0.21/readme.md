...
AndroidX Bindings NuGet Package Xamarin.AndroidX.CustomView 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.CustomView 
for Maven artifact:

artifact=androidx.customview:customview 

artifact_versioned=androidx.customview:customview:1.1.0

nuget=customview.1.1.0.21
