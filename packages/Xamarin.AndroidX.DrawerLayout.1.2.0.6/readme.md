...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DrawerLayout 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DrawerLayout 
for Maven artifact:

artifact=androidx.drawerlayout:drawerlayout 

artifact_versioned=androidx.drawerlayout:drawerlayout:1.2.0

nuget=drawerlayout.1.2.0.6
