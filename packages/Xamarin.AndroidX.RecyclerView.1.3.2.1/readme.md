...
AndroidX Bindings NuGet Package Xamarin.AndroidX.RecyclerView 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.RecyclerView 
for Maven artifact:

artifact=androidx.recyclerview:recyclerview 

artifact_versioned=androidx.recyclerview:recyclerview:1.3.2

nuget=recyclerview.1.3.2.1
