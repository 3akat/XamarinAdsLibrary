...
AndroidX Bindings NuGet Package Xamarin.AndroidX.ViewPager2 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.ViewPager2 
for Maven artifact:

artifact=androidx.viewpager2:viewpager2 

artifact_versioned=androidx.viewpager2:viewpager2:1.0.0

nuget=viewpager2.1.0.0.24
