...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Transition 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Transition 
for Maven artifact:

artifact=androidx.transition:transition 

artifact_versioned=androidx.transition:transition:1.4.1

nuget=transition.1.4.1.15
