...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Lifecycle.ViewModelSavedState 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Lifecycle.ViewModelSavedState 
for Maven artifact:

artifact=androidx.lifecycle:lifecycle-viewmodel-savedstate 

artifact_versioned=androidx.lifecycle:lifecycle-viewmodel-savedstate:2.6.2

nuget=lifecycle-viewmodel-savedstate.2.6.2.3
