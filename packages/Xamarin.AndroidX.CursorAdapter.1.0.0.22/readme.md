...
AndroidX Bindings NuGet Package Xamarin.AndroidX.CursorAdapter 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.CursorAdapter 
for Maven artifact:

artifact=androidx.cursoradapter:cursoradapter 

artifact_versioned=androidx.cursoradapter:cursoradapter:1.0.0

nuget=cursoradapter.1.0.0.22
