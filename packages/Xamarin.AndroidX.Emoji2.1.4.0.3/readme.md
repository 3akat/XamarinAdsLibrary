...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Emoji2 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Emoji2 
for Maven artifact:

artifact=androidx.emoji2:emoji2 

artifact_versioned=androidx.emoji2:emoji2:1.4.0

nuget=emoji2.1.4.0.3
