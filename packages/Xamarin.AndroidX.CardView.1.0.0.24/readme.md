...
AndroidX Bindings NuGet Package Xamarin.AndroidX.CardView 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.CardView 
for Maven artifact:

artifact=androidx.cardview:cardview 

artifact_versioned=androidx.cardview:cardview:1.0.0

nuget=cardview.1.0.0.24
