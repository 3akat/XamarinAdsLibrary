...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Emoji2.ViewsHelper 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Emoji2.ViewsHelper 
for Maven artifact:

artifact=androidx.emoji2:emoji2-views-helper 

artifact_versioned=androidx.emoji2:emoji2-views-helper:1.4.0

nuget=emoji2-views-helper.1.4.0.3
