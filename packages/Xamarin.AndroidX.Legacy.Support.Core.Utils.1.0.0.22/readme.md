...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Legacy.Support.Core.Utils 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Legacy.Support.Core.Utils 
for Maven artifact:

artifact=androidx.legacy:legacy-support-core-utils 

artifact_versioned=androidx.legacy:legacy-support-core-utils:1.0.0

nuget=legacy-support-core-utils.1.0.0.22
